...
const Destination = ({ DestinationImg, DestinationDate, DestinationNumber, DestinationName,
    DestinationDescription, DestinationCost, DestinationEvalNum }) => {
    return (
        <div className="DestinationContainer">
            <div className="DestinatioImg" >
                <img src={DestinationImg} alt="" />
                </div>
            <div className="DestinationDateNumContainer">
                <p className="DestinationDate">{DestinationDate}</p>
                <p className="DestinationNumber">{DestinationNumber}</p>
            </div>
            <p className="DestinationName">{DestinationName}</p>
            <p className="DestinationDescription">{DestinationDescription}</p>
            <div className="DestinationCostEval">
                <p className="DestinationCost"> {DestinationCost}</p>
                <div className="DestinationEval">
                    ...
                    <p className="DestinationEvalNum">{DestinationEvalNum}</p>
                </div>
            </div>
        </div>
    )
